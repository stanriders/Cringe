...
namespace Cringe.Types.OsuApi
{
    public class BeatmapShort
    {
        ...
        [JsonProperty("checksum")] public string Md5 { get; set; }

        [JsonProperty("beatmapset_id")] public int BeatmapSetId { get; set; }

        [JsonProperty("version")] public string Version { get; set; }

        [JsonProperty("mode_int")] public GameModes Mode { get; set; }

        [JsonProperty("mode")] public string ModeName { get; set; }
        ...
        [JsonProperty("count_circles")] public uint? Circles { get; set; }

        [JsonProperty("count_sliders")] public uint? Sliders { get; set; }

        [JsonProperty("count_spinners")] public uint? Spinners { get; set; }

        [JsonProperty("total_length")] public uint Length { get; set; }

        [JsonProperty("hit_length")] public uint DrainLength { get; set; }
        ...
        [JsonProperty("beatmapset")] public BeatmapSetShort BeatmapSet { get; set; }
    ...
    {
        [JsonProperty("max_combo")] public uint? MaxCombo { get; set; }
