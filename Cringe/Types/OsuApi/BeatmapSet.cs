...
namespace Cringe.Types.OsuApi
{
    public class BeatmapSetShort
    {
        ...
        [JsonProperty("creator")] public string CreatorName { get; set; }

        [JsonProperty("user_id")] public uint CreatorId { get; set; }

        [JsonProperty("status")] public string Status { get; set; }

        [JsonProperty("preview_url")] public string PreviewUrl { get; set; }

        [JsonProperty("covers")] public BeatmapSetCovers Covers { get; set; }
    ...
    public class BeatmapSet : BeatmapSetShort
    {
        ...
        [JsonProperty("user")] public UserShort Creator { get; set; }
    }
}