...
namespace Cringe.Types
{
    public class SubmittedScore
    {
        ...
        public override string ToString()
        {
            ...
            return $"{Id}|{Player.Username}|{Score}|{MaxCombo}|{Count50}|{Count100}|{Count300}|{CountMiss}|{CountKatu}|{CountGeki}|{FullCombo}|{Mods}|1|{LeaderboardPosition}|{PlayDateTime:yyMMddhhmmss}|1\n";
