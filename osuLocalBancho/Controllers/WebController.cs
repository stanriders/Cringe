...
namespace osuLocalBancho.Controllers
{
    ...
    public class WebController : ControllerBase
    {
        ...
        public async Task<IActionResult> SubmitScore([FromForm] string score, [FromForm] string iv, [FromForm] string osuver, [FromForm(Name = "x")] string quit, [FromForm(Name = "ft")] string failed)
        {
